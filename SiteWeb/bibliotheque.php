                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="#">Bibliothèque <span class="sr-only">(current)</span></a>
                        </li>
                    </ul>
            ...
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        ...
                        <p class="font-weight-light mt-4 text-danger">Nos livres sont classés par ordre alphabétique par défaut</p>
            ...
            <table class="table table-dark">
                ...
                <tbody>
                    <?php
                        ...
                        {
                            echo ('<tr>');
                            echo ('<td><a href="#">' . $livre['livre_nom'] . '</a></td>');
